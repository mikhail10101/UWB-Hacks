    ...
    return (
        <div className='flex flex-col rounded-3xl items-center w-[20rem] h-[20rem] gap-10'>
            ...
            <div className='flex flex-col gap-3'>
                <Link className="flex flex-row items-center gap-2 py-3 w-[15rem] justify-center outline rounded-3xl hover:bg-black hover:text-white"
                    href="/login/email">
                    <div className='w-5'>
                ...
                <button className="flex flex-row items-center gap-2 py-3 w-[15rem] justify-center outline rounded-3xl hover:bg-black hover:text-white"
